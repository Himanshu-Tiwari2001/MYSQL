...
-- Q1 ]---> • Find the name and city of those customers and salesmen who lives in the same city.
   select c.customer_name, s.name as "Salesman Name" ,s.city
   from customer  c ,  salesman s 
   where c.city =s.city;
   
   -- Q2 ]---> •Find the names of all customers along with the salesmen who works for them.
